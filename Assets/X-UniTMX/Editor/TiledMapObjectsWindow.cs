...
namespace X_UniTMX
{
	...
	public class TiledMapObjectsWindow : EditorWindow
	{
		...
		public static void Init(MapObjectLayer objectLayer)
		{
			...
			window.titleContent.text = "Map Object Layer";
		...
		void OnGUI()
		{
			...
			_mainFoldout = EditorGUILayout.Foldout(_mainFoldout, new GUIContent(titleContent.text, TiledMapComponentEditor.objectIcon));
