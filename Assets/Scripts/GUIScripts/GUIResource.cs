/*******************************************************************************
 *
 *  File Name: GUIResource.cs
 *
 *  Description: Old GUI for the Resource MapEvent event
 *
 *******************************************************************************/
using UnityEngine;
...
namespace GSP.JAVIERGUI
{
     ...
     * Name: GUIResource
     * 
     * Description: Creates the GUI for the Resource MapEvent.
     * 
     *******************************************************************************/
    public class GUIResource : MonoBehaviour 
	{
        ...
        GameplayStateMachine gameplayStateMachine; // The GamePlayStateMachine component reference; stop animation for MAIN GUI
        ...
        string headerString;            // The text in the OnGUI UI; the resource status text
		
		// Use this for initialization
		void Start()
        {
            guiMapEventsScript = GameObject.FindGameObjectWithTag("GUIMapEventSpriteTag").GetComponent<GUIMapEvents>();
            mapEventScript = GameObject.FindGameObjectWithTag("DieTag").GetComponent<MapEvent>();
            guiBottomBarScript = GameObject.FindGameObjectWithTag("GamePlayStateMachineTag").GetComponent<GUIBottomBar>();
            gameplayStateMachine = GameObject.FindGameObjectWithTag("GamePlayStateMachineTag").GetComponent<GameplayStateMachine>();
		} // end Start
        ...
        public void InitThis(int startX, int startY, int startWidth, int startHeight, string result)
		{
			...
			headerString = mapEventScript.GetResultString();
		} // end InitThis
        ...
        void ConfigDoneButton()
		{
            ...
            if (GUI.Button(new Rect(doneStartX, doneStartY, doneWidth, doneHeight), "DONE"))
			{
                ...
                gameplayStateMachine.StopAnimation();
			} // end if
